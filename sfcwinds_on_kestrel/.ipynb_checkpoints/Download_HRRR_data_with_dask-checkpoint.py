...
if __name__ == "__main__":
    ...
    cluster = LocalCluster(n_workers=16, threads_per_worker=1, memory_limit="4GB")  # Adjust the number of workers based on the CPUs per task in SLURM
    ...
    for date in date_range[:1]: 
        ...
        daily_file_path = os.path.join(save_folder, f"hrrr_{area}_{date.date()}_dask.nc")
        ...
        daily_datasets = compute(*delayed_datasets) 
